  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 w-full pb-6 sm:pb-8 pt-4 px-4 text-center text-white/50 text-[11px] sm:text-xs flex flex-col items-center z-10 pointer-events-none">
      <div className="flex flex-row items-center justify-center gap-1.5 sm:gap-2 mb-2 sm:mb-3 opacity-100">
        <span className="font-medium text-xs sm:text-sm text-white/80">Developed by:</span>
        <img src={peakLogo} alt="1NEPEAK" className="h-20 sm:h-24 w-auto object-contain mix-blend-screen drop-shadow-md" />
      </div>
